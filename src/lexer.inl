...
OPERATOR(OR_BREAK,    "or_break",               "or_break",    0,   true,  true)
OPERATOR(OR_CONTINUE, "or_continue",            "or_continue", 0,   true,  true)
...
KEYWORD(ELSE,        "else",        false) // Can also be an operator (x if y else z)
